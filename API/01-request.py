...
def busca_id_estado():
    """ Obtém um dicionario de estados no formato {id_estado: nome_estado}"""
...
def frequencia_nome(name):
    """Obtém um dicionario de frequencia de um nome por estado no formato{id_estado: frequencia}"""
...
def main(name):
    ...
    print(f"=== Frequência do nome {name} nos Estados (por 100.000 habitantes) entre os anos 2013 à 2023 ===")
